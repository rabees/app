                                    ...
                                    <div class="col-md-12 text-center">
                                        ...
                                        {{-- <button class="btn btn-info" type="button" data-toggle="modal"
                                            ...
                                            title="{{ __('Shortcut Keys information') }}"><i
                                                ...
                                                @if(session('time_report'))
                                                    <div class="alert alert-info">{{session('time_report')}}</div>
                                                @endif
                                    </div>
                                </div>
                            </form>
        ...
        <div class="row">
            <div id="videos">
                <div class="videoContainer">
                    <img src="{{ asset('/images/SECONDARY_LOGO.png') }}" class="meeting-logo"
...
@section('script')
    <script type="text/javascript">
        ...
        // const internet_connetection_status = JSON.parse;
